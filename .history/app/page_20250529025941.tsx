		...
		<section className="h-screen bg-[url('/zebra.jpg')] bg-cover bg-no-repeat bg-center text-black">
			<div className="h-full w-full flex flex-col justify-between p-6">
				...
				<div className="text-right font-bold leading-none border-r-8 border-black overflow-hidden pr-[2%]">
					<p className="introline text-[69px] min-[480px]:text-[90px] sm:text-[120px] lg:text-[150px] xl:text-[180px] 3xl:text-[215px] opacity-0 -translate-x-full">
						THE SAFARI
					</p>
					<p className="bigline text-[69px] min-[480px]:text-[90px] sm:text-[120px] lg:text-[150px] xl:text-[180px] 3xl:text-[215px] opacity-0 -translate-x-full">
						NATURE’S BANK
					</p>
				</div>
			</div>
